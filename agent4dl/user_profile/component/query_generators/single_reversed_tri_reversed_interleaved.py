...
from agent4dl.user_profile.component.query_generators.base import BaseQueryGenerator

from agent4dl.user_profile.component.query_generators.single_term_reversed import SingleTermQueryGeneratorReversed
from agent4dl.user_profile.component.query_generators.tri_term_reversed import TriTermQueryGeneratorReversed
